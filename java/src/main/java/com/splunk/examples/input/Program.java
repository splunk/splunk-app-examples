...
public class Program {
    ...
    static void DisplaySpecificInput(Input input) {
        ...
        if (inputKind == InputKind.Monitor) {
            ...
            System.out.println("      file count:      " + monitorInput.getFileCount());
            System.out.println("      host:            " + monitorInput.getHost());
            System.out.println("      index:           " + monitorInput.getIndex());
            System.out.println("      receive buffer:  " + monitorInput.getRcvBuf());
        } else if (inputKind == InputKind.Script) {
            ScriptInput scriptInput = (ScriptInput) input;
            System.out.println("      group:           " + scriptInput.getGroup());
            System.out.println("      host:            " + scriptInput.getHost());
            System.out.println("      index:           " + scriptInput.getIndex());
            System.out.println("      interval:        " + scriptInput.getInterval());
            System.out.println("      receive buffer:  " + scriptInput.getRcvBuf());
        } else if (inputKind == InputKind.Tcp) {
            TcpInput tcpInput = (TcpInput) input;
            System.out.println("      connection host: " + tcpInput.getConnectionHost());
            System.out.println("      group:           " + tcpInput.getGroup());
            System.out.println("      host:            " + tcpInput.getHost());
            System.out.println("      index:           " + tcpInput.getIndex());
            System.out.println("      queue:           " + tcpInput.getQueue());
            System.out.println("      receive buffer:  " + tcpInput.getRcvBuf());
            System.out.println("      restrict to host:" + tcpInput.getRestrictToHost());
            System.out.println("      source:          " + tcpInput.getSource());
            System.out.println("      source type:     " + tcpInput.getSourceType());
            System.out.println("      SSL:             " + tcpInput.getSSL());
        } else if (inputKind == InputKind.TcpSplunk) {
            TcpSplunkInput tcpSplunkInput = (TcpSplunkInput) input;
            System.out.println("      connection host: " + tcpSplunkInput.getConnectionHost());
            System.out.println("      group:           " + tcpSplunkInput.getGroup());
            System.out.println("      host:            " + tcpSplunkInput.getHost());
            System.out.println("      index:           " + tcpSplunkInput.getIndex());
            System.out.println("      queue:           " + tcpSplunkInput.getQueue());
            System.out.println("      receive buffer:  " + tcpSplunkInput.getRcvBuf());
            System.out.println("      source:          " + tcpSplunkInput.getSource());
            System.out.println("      source type:     " + tcpSplunkInput.getSourceType());
            System.out.println("      SSL:             " + tcpSplunkInput.getSSL());
        } else if (inputKind == InputKind.Udp) {
            UdpInput udpInput = (UdpInput) input;
            System.out.println("      connection host: " + udpInput.getConnectionHost());
            System.out.println("      group:           " + udpInput.getGroup());
            System.out.println("      host:            " + udpInput.getHost());
            System.out.println("      index:           " + udpInput.getIndex());
            System.out.println("      queue:           " + udpInput.getQueue());
            System.out.println("      receive buffer:  " + udpInput.getRcvBuf());
            System.out.println("      source:          " + udpInput.getSource());
            System.out.println("      source type:     " + udpInput.getSourceType());
            System.out.println("      no timestamp append:" +
                            udpInput.getNoAppendingTimeStamp());
            System.out.println("      no priority stripping:" +
            ...
            System.out.println("      monitor subnodes:" +
            ...
            System.out.println("      WQL:             " + windowsWmiInput.getWql());
        }
    }
