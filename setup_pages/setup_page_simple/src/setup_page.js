...
jquery("#setup_button").on("click", completeSetup);
...
async function completeSetup() {
    ...
    const passwordToSave = jquery('#password_input').val();
    ...
    try {
        ...
        jquery('#error_details').html(errText);
    }
}
