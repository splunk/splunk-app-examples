...
define(["react", "splunkjs/splunk"], function(react, splunk_js_sdk){
  ...
  class SetupPage extends react.Component {
    ...
    render() {
      return e("div", null, [
        e("h2", null, "Check to see if dependent app is installed and has the required version. App configuration is not complete without it. If dependency requirements are satisfied, the app configuration will complete."),
        e("div", null, [
